...
//init 0 to memory and registers
...
{
    assert(size+CHIP8_PROGRAM_LOAD_ADDRESS < CHIP8_MEMORY_SIZE); //integer overflow here lol to change the registers -> and pc.
	//the funny part is because it is a virtual machine the pc wont do any real opcode so no vurn here ;)
